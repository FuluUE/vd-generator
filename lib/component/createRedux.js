...
exports.default = (config, opts) => {
    ...
    if (!(0, _fsExtra.existsSync)((0, _path.join)(vdConfigPath, camelCaseName + '.json'))) {
        ...
        opts = _extends({}, (0, _fsExtra.readJSONSync)((0, _path.join)(vdConfigPath, camelCaseName + '.json')), opts);
    }
    if (opts.saga) {
