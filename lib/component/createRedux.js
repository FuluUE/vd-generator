...
exports.default = (config, opts) => {
    ...
    if (opts.saga) {
        ...
        (0, _fsExtra.writeFileSync)((0, _path.join)(servicePath, name + '.js'), (0, _mustache2.default)('services.mustache', _extends({
            name: name
        }, opts.saga)));
        ...
        (0, _fsExtra.writeFileSync)((0, _path.join)(modelPath, name + '.js'), (0, _mustache2.default)('model.mustache', {
            name: name,
